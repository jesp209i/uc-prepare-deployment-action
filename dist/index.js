...
var require_lib = __commonJS({
  "node_modules/@actions/http-client/lib/index.js"(exports) {
    ...
    })(MediaTypes2 = exports.MediaTypes || (exports.MediaTypes = {}));
    ...
    var HttpClient2 = class {
      ...
      postJson(requestUrl, obj, additionalHeaders = {}) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          additionalHeaders[Headers2.Accept] = this._getExistingOrDefaultHeader(additionalHeaders, Headers2.Accept, MediaTypes2.ApplicationJson);
          additionalHeaders[Headers2.ContentType] = this._getExistingOrDefaultHeader(additionalHeaders, Headers2.ContentType, MediaTypes2.ApplicationJson);
...
async function run() {
  try {
    ...
    const commitMessage = (0, import_core.getInput)("commit-message");
    ...
    (0, import_core.info)("Requested Deployment from Umbraco CLoud.");
    (0, import_core.info)("----------------------------------------");
    (0, import_core.info)(`Deployment Id: ${obj.deploymentId}`);
    (0, import_core.setOutput)("DEPLOYMENT_ID", obj.deploymentId);
  } catch (error) {
    console.log(error);
    (0, import_core.setFailed)("Got an error while trying to prepare a deployment");
  }
}
run();
