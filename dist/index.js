...
async function run() {
  try {
    ...
    const commitMessage = (0, import_core.getInput)("commit-message", { required: true });
    ...
    const deploymentResponse = response;
    (0, import_core.info)("Requested Deployment from Umbraco Cloud.");
    (0, import_core.info)("----------------------------------------");
    (0, import_core.info)(`Deployment Id: ${deploymentResponse.deploymentId}`);
    (0, import_core.setOutput)("DEPLOYMENT_ID", deploymentResponse.deploymentId);
  } catch (error) {
    console.log(error);
